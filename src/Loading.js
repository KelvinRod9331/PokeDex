...
// Full Credit To Joel T Bennett For This Code: https://codepen.io/JTBennett/
const loading = () => {
  return (
    <div>
      <svg id="loading">
        <g>
          ...
          <path class="ld-o" 
          fill="#39C0C4" 
          d="M74.7,25.1c0,1.5-0.3,2.9-0.8,4.2c-0.5,1.3-1.2,2.4-2.2,3.3c-0.9,0.9-2,1.6-3.3,
          2.2c-1.3,0.5-2.6,0.8-4.1,0.8s-2.8-0.3-4.1-0.8c-1.3-0.5-2.4-1.2-3.3-2.2s-1.6-2-2.2-3.3C54.3,28,54,26.6,54,25.1s0.3-2.9,0.8-4.2
